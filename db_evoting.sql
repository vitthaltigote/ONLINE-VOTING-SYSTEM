...
-- default charset for InnoDB is Latin1, which means that the database uses ASCII characters to store data
...
-- any column should not empty so we use not null constraint on col.
...
ALTER TABLE `tbl_admin`
 ADD PRIMARY KEY (`aid`);
--primary key means that col should unique values and not  null data
--
