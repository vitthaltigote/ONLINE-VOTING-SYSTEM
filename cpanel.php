            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  // progress bar are copy pasted through online platform
                  ...
                  <div class='progress'>
                    ...
                    <div class='progress-bar progress-bar-success' 
                     role='progressbar'
                     aria-valuenow=\"$bjp_value\" 
                     aria-valuemin=\"0\" 
                     aria-valuemax=\"100\" 
                     style='width: ".$bjp_value."%'>
...
// //////////////////////////////////////////////////////////////////////////////////////////
                ...
                $total=0;//variable for total user data entry count

                // Total
                $sql ="SELECT * FROM tbl_users";//fire query and save return in a var
                $result= mysqli_query($conn, $sql);//to save table result set

                // $data= mysqli_num_rows($result) //for total count of data rows in table data

                if(mysqli_num_rows($result)>0)
                {

                      // mysqli_fetch_assoc($result) // this function count result set index values in 1 or 0 if there is value return true
